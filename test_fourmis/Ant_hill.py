import Queen_ant
from Basic_ant import Basic_ant
from Queen_ant import Queen_ant
import random
import json
import os
...
class Ant_hill:
    ...
    def addAnt(self, day):
        ...
        """
        newAnt = Basic_ant(True, day, "adulte")
    ...
    def addQueen(self, day):
        ...
        """
        newQueen = Queen_ant(True, day, "adulte")
    ...
    def killAnt(self):
        ...
        if len(self.ant_list) == 0:
            raise IndexError("il n'y a plus de fourmis dans cette colonny")
        else:
